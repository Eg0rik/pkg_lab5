...
{
    std::ifstream fin("/Users/mac/Desktop/lab5_code/input.txt");
...
//точка пересечения отрезка с границей окна отсечения, если она есть
...
//параметр t для отрезков и граней полигона, чтобы определить их пересечение
